...
@Entity
@Table(name = "storages", schema = "ghost", catalog = "")
public class StoragesEntity {
    ...
    public boolean equals(Object o) {
        ...
        return id == that.id && cid == that.cid && itemId == that.itemId && quantity == that.quantity && spirit == that.spirit && level1 == that.level1 && level2 == that.level2 && level3 == that.level3 && level4 == that.level4 && level5 == that.level5 && level6 == that.level6 && level7 == that.level7 && level8 == that.level8 && level9 == that.level9 && level10 == that.level10 && fusion == that.fusion && isLocked == that.isLocked && icon == that.icon && term == that.term && type == that.type && slot == that.slot && money == that.money;
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, cid, itemId, quantity, spirit, level1, level2, level3, level4, level5, level6, level7, level8, level9, level10, fusion, isLocked, icon, term, type, slot, money);
    }
}
